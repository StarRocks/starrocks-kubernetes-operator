...
We have split the kube-celerdata chart into two subcharts: operator and starrocks since v1.8.0.

Installing kube-celerdata is equivalent to installing both operator and starrocks subcharts, and uninstalling
kube-celerdata is equivalent to uninstalling both operator and starrocks subcharts.

If you want more flexibility in managing your CelerData clusters, you can install operator and starrocks subcharts
separately.
...
1. `kube-celerdata` includes two subcharts, `operator` and `starrocks`.
...
3. `starrocks` is the Helm chart for CelerData cluster.
   See [starrocks](../helm-charts/charts/kube-celerdata/charts/starrocks/README.md) for more details.
