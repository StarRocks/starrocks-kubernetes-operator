...
var _ SpecInterface = &CelerDataComponentSpec{}

// CelerDataComponentSpec defines the shared specification for all CelerData components except FE Proxy
type CelerDataComponentSpec struct {
	CelerDataLoadSpec `json:",inline"`

	// RunAsNonRoot is used to determine whether to run CelerData as a normal user.
	...
	// Sidecars is an optional list of containers that are run in the same pod as the CelerData component.
	...
	// InitContainers is an optional list of containers that are run in the same pod as the CelerData component.
	...
	// CelerDataCluster use StatefulSet to deploy FE/BE/CN components.
...
// CelerDataComponentStatus represents the status of a CelerData component.
type CelerDataComponentStatus struct {
...
func (spec *CelerDataComponentSpec) GetHostAliases() []corev1.HostAlias {
	return spec.HostAliases
}

func (spec *CelerDataComponentSpec) GetRunAsNonRoot() (*int64, *int64) {
...
func (spec *CelerDataComponentSpec) GetTerminationGracePeriodSeconds() *int64 {
...
func (spec *CelerDataComponentSpec) GetCapabilities() *corev1.Capabilities {
	return spec.Capabilities
}

func (spec *CelerDataComponentSpec) GetSidecars() []corev1.Container {
	return spec.Sidecars
}

func (spec *CelerDataComponentSpec) GetInitContainers() []corev1.Container {
	return spec.InitContainers
}

func (spec *CelerDataComponentSpec) GetCommand() []string {
	return spec.Command
}

func (spec *CelerDataComponentSpec) GetArgs() []string {
	return spec.Args
}

func (spec *CelerDataComponentSpec) GetSysctls() []corev1.Sysctl {
	return spec.Sysctls
}

func (spec *CelerDataComponentSpec) GetUpdateStrategy() *appsv1.StatefulSetUpdateStrategy {
...
func (spec *CelerDataComponentSpec) IsReadOnlyRootFilesystem() *bool {
...
func (spec *CelerDataComponentSpec) GetMinReadySeconds() *int32 {
	return spec.MinReadySeconds
}

func (spec *CelerDataComponentSpec) GetPodManagementPolicy() appsv1.PodManagementPolicyType {
