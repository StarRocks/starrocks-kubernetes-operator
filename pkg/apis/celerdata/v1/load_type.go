...
// loadInterface represents a contract for managing workload specifications in CelerData applications.
...
var _ loadInterface = &CelerDataLoadSpec{}

type CelerDataLoadSpec struct {
	...
	// object in K8S will be reset to the value specified by the 'Replicas'
	// field, erasing the value previously set by HPA.
	// +kubebuilder:validation:Minimum=0
	// +kubebuilder:default=1
	// +optional
	Replicas *int32 `json:"replicas,omitempty"`

	// Image for a CelerData deployment.
	// +optional
	...
	// +optional
	Service *CelerDataService `json:"service,omitempty"`
	...
	// the reference for configMap which store the config info to start CelerData. e.g. be.conf, fe.conf, cn.conf.
	// +optional
...
func (spec *CelerDataLoadSpec) GetImage() string {
	return spec.Image
}

// CelerDataService defines external service for CelerData component.
type CelerDataService struct {
	...
	// internal). CelerData may add its own default labels.
	// +optional
	...
	// CelerDataServicePort.NodePort field.
	// +optional
	Ports []CelerDataServicePort `json:"ports,omitempty"`
...
// CelerDataServicePort defines the port that will be exposed by this service.
...
type CelerDataServicePort struct {
...
// CelerDataProbe defines the mode for probe be alive.
type CelerDataProbe struct {
...
func (spec *CelerDataLoadSpec) GetReplicas() *int32 {
	return spec.Replicas
}

func (spec *CelerDataLoadSpec) GetStorageVolumes() []StorageVolume {
	return spec.StorageVolumes
}

func (spec *CelerDataLoadSpec) GetServiceAccount() string {
	return spec.ServiceAccount
}

func (spec *CelerDataLoadSpec) GetAffinity() *corev1.Affinity {
	return spec.Affinity
}

func (spec *CelerDataLoadSpec) GetTopologySpreadConstraints() []corev1.TopologySpreadConstraint {
	return spec.TopologySpreadConstraints
}

func (spec *CelerDataLoadSpec) GetTolerations() []corev1.Toleration {
	return spec.Tolerations
}

func (spec *CelerDataLoadSpec) GetService() *CelerDataService {
	return spec.Service
}

func (spec *CelerDataLoadSpec) GetNodeSelector() map[string]string {
	return spec.NodeSelector
}

func (spec *CelerDataLoadSpec) GetImagePullSecrets() []corev1.LocalObjectReference {
	return spec.ImagePullSecrets
}

func (spec *CelerDataLoadSpec) GetAnnotations() map[string]string {
	return spec.Annotations
}

func (spec *CelerDataLoadSpec) GetSchedulerName() string {
	return spec.SchedulerName
}

func (spec *CelerDataLoadSpec) GetStartupProbeFailureSeconds() *int32 {
	return spec.StartupProbeFailureSeconds
}

func (spec *CelerDataLoadSpec) GetLivenessProbeFailureSeconds() *int32 {
	return spec.LivenessProbeFailureSeconds
}

func (spec *CelerDataLoadSpec) GetReadinessProbeFailureSeconds() *int32 {
	return spec.ReadinessProbeFailureSeconds
}

func (spec *CelerDataLoadSpec) GetLifecycle() *corev1.Lifecycle {
	return spec.Lifecycle
}

func (spec *CelerDataLoadSpec) GetShareProcessNamespace() *bool {
	return spec.ShareProcessNamespace
}

func (spec *CelerDataLoadSpec) GetImagePullPolicy() corev1.PullPolicy {
