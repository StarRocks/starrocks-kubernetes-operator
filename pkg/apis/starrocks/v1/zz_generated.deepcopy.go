...
func (in *StarRocksClusterSpec) DeepCopyInto(out *StarRocksClusterSpec) {
	*out = *in
	...
	if in.StarRocksFeObserverSpec != nil {
		in, out := &in.StarRocksFeObserverSpec, &out.StarRocksFeObserverSpec
		*out = new(StarRocksFeObserverSpec)
		(*in).DeepCopyInto(*out)
	}
...
func (in *StarRocksClusterStatus) DeepCopyInto(out *StarRocksClusterStatus) {
	*out = *in
	...
	if in.StarRocksFeObserverStatus != nil {
		in, out := &in.StarRocksFeObserverStatus, &out.StarRocksFeObserverStatus
		*out = new(StarRocksFeObserverStatus)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StarRocksFeObserverSpec) DeepCopyInto(out *StarRocksFeObserverSpec) {
	*out = *in
	in.StarRocksComponentSpec.DeepCopyInto(&out.StarRocksComponentSpec)
	if in.FeEnvVars != nil {
		in, out := &in.FeEnvVars, &out.FeEnvVars
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StarRocksFeObserverSpec.
func (in *StarRocksFeObserverSpec) DeepCopy() *StarRocksFeObserverSpec {
	if in == nil {
		return nil
	}
	out := new(StarRocksFeObserverSpec)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *StarRocksFeObserverStatus) DeepCopyInto(out *StarRocksFeObserverStatus) {
	*out = *in
	in.StarRocksComponentStatus.DeepCopyInto(&out.StarRocksComponentStatus)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new StarRocksFeObserverStatus.
func (in *StarRocksFeObserverStatus) DeepCopy() *StarRocksFeObserverStatus {
	if in == nil {
		return nil
	}
	out := new(StarRocksFeObserverStatus)
