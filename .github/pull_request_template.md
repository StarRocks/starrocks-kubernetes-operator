...
- [ ] make sure you have updated the [values.yaml](../helm-charts/charts/kube-celerdata/charts/celerdata/values.yaml)
  file of celerdata chart.
- [ ] In `scripts` directory, run `bash create-parent-chart-values.sh` to update the values.yaml file of the parent
  chart( kube-celerdata chart).
